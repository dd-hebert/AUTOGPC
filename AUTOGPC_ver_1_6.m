classdef AUTOGPC_ver_1_6 < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.Credits.Position = [531 10 79 22];
            app.Credits.Text = 'App by David Hebert';
            ...
            app.ExportsaPDFreportandhighresoltuionPNGsofallchromatogramsLabel.Position = [845 378 160 49];
